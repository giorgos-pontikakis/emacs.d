...
(custom-theme-set-faces
 'gnp-dark
 '(default ((t (:family "fixed" :foundry "misc" :width semi-condensed :height 100 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "white" :background "black" :stipple nil :inherit nil))))
 ...
 '(show-paren-match-face ((t (:weight bold :underline nil :foreground "red")))))
